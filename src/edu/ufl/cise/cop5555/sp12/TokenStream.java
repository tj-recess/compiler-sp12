...
public class TokenStream
{
    ...
    // Instances cannot be created directly (the constructor is private); use
    // the public iterator() method.
    ...
    // This method returns a new TokenStreamIterator for this TokenStream
    // instance.
    ...
    // This is a non-static inner class. Each instance is implicitly linked with
    // an
    ...
    public class Token
    {
            ...
            for (int i = beg + 1; i < end - 1; i++)
            {
                ...
                if (curr == '\\')
                {
                    ...
                    case 'r':
                        ...
                        break;
                    case '\"':
                        sb.append('\"'); // note that the quote is escaped for
                                         // Java. Only the " will be appended
                        break;
                    case '\\':
                        sb.append('\\'); // note that the \ is escaped for Java.
                                         // Only one \ will be appended.
                        break;
                    default:
        ...
        // converts to String, if String literal, removes delimiting "s and
        // handles escapes.
        // if token is error, surrounds text with %# #%, if EOF, the text is
        // EOF.
